    ...
    <>
      <div className="bg-gray-100 pt-6 pb-16 rounded-lg shadow-lg w-11/12 m-aut relative ml-auto mr-auto">
        ...
        <div className={`banner flex items-center justify-between m-auto w-11/12 text-gray-700 `}>
          <div className={`absolute left-0 right-0 h-10 rounded-2xl  mx-auto w-11/12 ${step1 ? 'bg-green-200' : (step2 ? 'bg-green-300' : 'bg-green-400')}`}>
          </div>
          ...
          <div className={`step relative w-32 h-32 flex rounded flex-col justify-center items-center z-3 text-center  rounded-full ${step3 ? 'animate-pulse	 bg-green-400 w-44 ' : ''}`} id="step3">
