      ...
      <>
        <div className="bg-gray-100 pt-4 pb-12 rounded-lg shadow-lg w-11/12 m-auto relative ml-auto mr-auto">
          ...
          <div className="banner flex items-center justify-between m-auto w-11/12 text-gray-700 ">
            <div className="absolute left-0 right-0 h-7 rounded-2xl  mx-auto w-11/12 bg-green-100">
            </div>
  
            <div className="step relative w-24 h-16 flex rounded-full flex-col justify-center items-center z-3 text-center rounded bg-green-200 w-44" id="step1">
              <img src="/images/check.png" alt="" width={'17px'} className="z-10" />
              <p className="animate-visible text-xs">Select</p>
            </div>
            <div className="step relative w-32 h-24 flex rounded-full flex-col justify-center items-center z-3 text-center rounded bg-green-200 w-44" id="step2">
              <img src="/images/cart.png" alt="" width={'30px'} className="z-10" />
              <p className="animate-visible">Add to cart</p>
            </div>
            <div className="step relative w-32 h-24 flex rounded flex-col justify-center items-center z-3 text-center rounded-full bg-green-100 w-44">
